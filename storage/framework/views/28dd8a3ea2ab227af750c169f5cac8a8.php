        ...
        <div class="container">
          <div class="row justify-content-center pb-3 pt-6 ps-3 px-md-3 px-lg-3 d-flex  text-md-start">
            ...
            <div class="col-md-3 col-lg-3 col-6 mb-3 pe-0">
              <ul class="list-unstyled mb-md-4 mb-lg-0">
                <li class="mb-2"><span class="foo-link-icn mx-2"> > </span> <a
                    class="text-100 fw-light text-decoration-none" href="index.html"> الرئيسية</a></li>
                <li class="mb-2"><span class="foo-link-icn mx-2"> > </span><a
            ...
            <div class="col-md-3 col-lg-3 col-6 mb-3">
              <ul class="list-unstyled mb-md-4 mb-lg-0">
                <li class="mb-2"><span class="foo-link-icn mx-2"> > </span> <a
                    class="text-100 fw-light text-decoration-none" href="create-ad.html"> أضف لوحتك</a>
                </li>
                <li class="mb-2"><span class="foo-link-icn mx-2"> > </span><a
                    class="text-100 fw-light text-decoration-none" href="account.html"> حسابي </a>
                </li>
                <li class="mb-2"><span class="foo-link-icn mx-2"> > </span><a
...
<?php /**PATH C:\wamp64\www\projects\sumou\resources\views/layouts/front/header.blade.php ENDPATH**/ ?>