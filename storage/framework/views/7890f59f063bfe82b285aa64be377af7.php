    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row">
                <?php if($ad->user->whatsapp != '' && $ad->user->whatsapp != 0): ?>
                <div class="col-lg-6 col-md-6 col-6">
                    <a href="https://wa.me/+966<?php echo e($ad->user->whatsapp); ?>" target="_blank" class="whatsapp">
                ...
                <?php endif; ?>
                <div class="col-lg-6 col-md-6 col-6">
                    <a href="tel:+966<?php echo e($ad->phone); ?>" class="whatsapp text-dark-blue">
                        <i class=" las la-phone d-flex justify-content-center align-content-center flex-column text-center" style="font-size: 30px;"> <span class="fs-13px fw-bold ltr"> +966<?php echo e($ad->phone); ?> </span></i>
                    </a>
                </div>
