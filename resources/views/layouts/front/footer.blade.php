          ...
          <div class="row justify-content-center pb-3 pt-6 ps-3 px-md-3 px-lg-3 d-flex  text-md-start">
            <div class="col-md-3 col-xs-12 mb-3 mb-5 mb-lg-0 d-none d-md-block d-lg-block">
              <a class="d-flex___ align-items-center__ fw-semi-bold fs-3 text-center" href="#">
                <img class="me-3" src="{{ asset('assets/')}}/img/logo_white.png" alt="سمو" width="120" />
              </a>
            ...
            <div class="col-md-3 col-lg-3 col-6 mb-3 pe-0">
              <ul class="list-unstyled mb-md-4 mb-lg-0">
                <li class="mb-2"><span class="foo-link-icn mx-2"> > </span> <a
                    class="text-100 fw-light text-decoration-none" href="{{route('home')}}"> الرئيسية</a></li>
                <li class="mb-2"><span class="foo-link-icn mx-2"> > </span><a
              ...
              <ul class="list-unstyled mb-md-4 mb-lg-0">
                @if (auth()->check())
                  <li class="mb-2"><span class="foo-link-icn mx-2"> > </span> 
                    <a class="text-100 fw-light text-decoration-none" href="{{route('ads.create')}}"> أضف لوحتك</a>
                  </li>
                  <li class="mb-2"><span class="foo-link-icn mx-2"> > </span>
                    <a class="text-100 fw-light text-decoration-none" href="{{route('user.profile')}}"> حسابي </a>
                  </li>
                  @else
                  <li class="mb-2"><span class="foo-link-icn mx-2"> > </span> 
                    <a class="text-100 fw-light text-decoration-none" href="{{route('login')}}"> تسجيل الدخول </a>
                  </li>
                  <li class="mb-2"><span class="foo-link-icn mx-2"> > </span>
                    <a class="text-100 fw-light text-decoration-none" href="{{route('register')}}"> أنشىء حسابك </a>
                  </li>
                @endif
            ...
            <div class="col-md-3 col-xs-12 mb-3 mb-4 d-flex align-items-center justify-content-center">
              <div class="row text-center">
                <div class="col-12 logo-2030 d-none">
                  <img src="{{ asset('assets/')}}/img/2030.png" alt="2030 رؤية">
                </div>
