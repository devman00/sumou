    ...
    <section class=" affair dashboard d-flex flex-column justify-content-between">
        <div class="container px-0 row">
            ...
            <div class="affair-step col-md-10 col-lg-10 mt-md-5 mt-lg-5">
                ...
                <!-- Start Form -------  -->
                <form action="{{route('ads.store')}}" method="post" id="form-submit" class=" fill-details bg-white ps-4 px-lg-8 ">
                    @csrf
                            ...
                            <div class="col ">
                                <div class="switch-field type-lawha">
                                    <div class=" form-check" >
                                        <input class="form-check-input" value="خصوصي" name="plate_type" type="radio" id="plate-private" checked {{ old('plate_type') == "خصوصي" ? 'checked' : '' }} >
                            ...
                            <div class="row add-lawha-radio no-gap  d-flex justify-content-center align-items-start flex-row position-relative gap-4 mb-3 "
                                ...
                                <div class="col mb-3 ">
                                    <div class="switch-field">
                                        <div class=" form-check">
                                            <input class="form-check-input" name="validity_of_periodic_examination" value="جديد" type="radio" id="validity_of_periodic_examination_new"  checked {{ old('validity_of_periodic_examination') == "جديد" ? 'checked' : '' }}>
                         ...
                         <div class="add-lawha-radio-container col d-flex justify-self-start flex-row flex-wrap align-items-start  ">
                            <div class="row add-lawha-radio no-gap  d-flex justify-content-center align-items-start flex-row position-relative gap-4 mb-3 "
                                ...
                                <div class="col mb-3 ">
                                    <div class="switch-field">
                                        <div class=" form-check">
                                            <input class="form-check-input" name="validity_of_driving_form" value="ساري" type="radio" id="validity_of_driving_form_new" checked {{ old('validity_of_driving_form') == "ساري" ? 'checked' : '' }} >
                        ...
                        <div class="add-lawha-radio-container col d-flex justify-self-start flex-row flex-wrap align-items-start  ">
                            <div class="row add-lawha-radio  d-flex justify-content-center align-items-start flex-row position-relative gap-4 "
                                ...
                                <div class="col mb-3 ">
                                    <div class="switch-field">
                                        <div class=" form-check">
                                            <input class="form-check-input" name="vehicle_insurance_status" value="جديد" type="radio" id="vehicle_insurance_status_new" checked {{ old('vehicle_insurance_status') == "جديد" ? 'checked' : '' }} >
                            ...
                            <div class="row add-lawha-radio  d-flex justify-content-center align-items-start flex-row position-relative gap-4 "  style="width: 390px !important; ">
                                ...
                                <div class="col mb-3 ">
                                    <div class="switch-field">
                                        ...
                                        <div class="form-check ">
                                            <input class="form-check-input" name="are_there_violations" value="لا" type="radio"  id="are_there_violations_no" checked {{ old('are_there_violations') == "لا" ? 'checked' : '' }} >
                    ...
                    <div class="d-flex controls d-flex flex-row align-items-center justify-content-start py-2 gap-1">
                        ...
                        <div class="col textfields py-1 d-flex flex-column align-items-start justify-content-start gap-3  ps-lg-4 px-0 "  style="border-left:#cac7c7 1px solid ; padding-left: 5px;">
                            <div class="textfield-input   m-0 d-flex justify-content-center align-items-center">
                                ...
                                <input type="text" class="font-tajawal bg-transparent text-right custom_input price_input ms-md-1 ms-lg-1" name="price"  value="{{old('price')}}" id="price"  placeholder="100 ريال " >
                            </div>
