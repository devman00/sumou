            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-6">
                    <a href="tel:00966{{$ad->phone}}" class="whatsapp text-dark-blue">
                        <i class=" las la-phone d-flex justify-content-center align-content-center flex-column text-center" style="font-size: 30px;"> <span class="fs-13px fw-bold"> 00966{{$ad->phone }} </span></i>
                    </a>
                </div>
