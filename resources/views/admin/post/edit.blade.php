...
@section('content')
    ...
    {{-- page heading  --}}
    <x-admin.page-heading heading="Edit Post"/>
                                ...
                                <form action="{{ route('admin.posts.update', $post->id) }}" method="post" class="form" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-12 d-flex">
                                            <div class="mb-4">
                                                <img class="h200" src="{{ url('storage/images/posts/' . $post->thumbnail) }}" alt="">
                                            </div>
                                            <div class="ms-4">
                                                <x-admin.form-group>
                                        ...
                                        <div class="col-md-12 col-12 mt-3">
                                            <x-admin.form-group>
                                                ...
                                                <x-admin.form-input id="" name="title" placeholder="Add post Title" value="{{ $post->title }}" />
                                        ...
                                        <div class="col-md-12 col-12">
                                            <x-admin.form-group>
                                                ...
                                                <x-admin.form-textarea id="" name="description" rows="3" placeholder="Add your description..">{{ $post->description }}</x-admin.form-textarea>
                                        ...
                                        <div class="col-md-12 col-12">
                                            <x-admin.form-group>
                                                ...
                                                <x-admin.form-textarea id="html-editor" name="content" rows="5" placeholder="Add your content..">{{ $post->content }}</x-admin.form-textarea>
                                        ...
                                        <div class="col-md-12 col-12">
                                            <x-admin.form-group>
                                                ...
                                                <x-admin.form-select id="" name="status" isMultiple="false" >  
                                                    ...
                                                    <option value="0" {{ ($post->status != 1 ) ? 'selected' : '' }} >Disabled</option>
                                                </x-admin.form-select> 
