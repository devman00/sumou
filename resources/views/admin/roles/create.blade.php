...
@section('content')
    ...
    {{-- page heading  --}}
    <x-admin.page-heading heading="Create Role"/>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-12">
                                            <x-admin.form-group>
                                                ...
                                                <x-admin.form-input id="" name="name" placeholder="Add role Name" value="{{ old('name') }}" />
                                        ...
                                        <div class="col-md-12 col-12">
                                            <x-admin.form-group>
                                                ...
                                                <x-admin.form-input id="display_name" name="display_name" placeholder="role display_Name" value="{{ old('display_name') }}" />
                                        ...
                                        <div class="col-md-12 col-12">
                                            <x-admin.form-group>
                                                ...
                                                <x-admin.form-textarea id="" name="description" rows="3" placeholder="Add your role description..">{{ old('description') }}</x-admin.form-textarea>
                                                                        ...
                                                                        <div class="form-check">
                                                                            <div class="custom-control custom-checkbox">
                                                                                <input type="checkbox" class="form-check-input form-check-info"
                                                                                    name="permissions[]" id="{{ $val['name'] }}Check" value="{{ $val['id'] }}"  >
